...
public class Horario extends AppCompatActivity implements View.OnClickListener {
    ...
    String HttpURL = "https://www.barberapp.cl/BarberApp/InsertHora.php";
    String HttpURL2 = "https://www.barberapp.cl/BarberApp/HorasList.php";
    String HttpURL3 = "https://www.barberapp.cl/BarberApp/DeleteSolicitud.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //        helper.cerrar();
                ...
                //new CargarDatos().execute("https://www.barberapp.cl/BarberApp/registro.php?fecha="+txtFecha.getText().toString()+"&hora="+txtHora.getText().toString()+"&solicitud="+txtPeluqueros.getText().toString());
    ...
    private class BackTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void...params){
            ...
            try{
                ...
                HttpPost httppost= new HttpPost("https://www.barberapp.cl/BarberApp//BarberiaList.php");

...
public class MapsActivityD extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.cerrar){
            ...
            Intent actionC = new Intent(MapsActivityD.this,MainActivity.class);
            ...
            Intent actionP = new Intent(MapsActivityD.this,AdminMain.class);
            startActivity(actionP);
            finish();
        }
        else if(id == R.id.adminHorario){
            text = "Abriendo ventana de horarios";
            Intent actionP = new Intent(MapsActivityD.this,HorarioD.class);
            startActivity(actionP);
            finish();
        }
            ...
            Intent actionM = new Intent(MapsActivityD.this,Asientos.class);
            startActivity(actionM);
            finish();
        }
        else if(id == R.id.config){
            text = "Abriendo ventana de administración de horarios de atención";
            Intent actionT = new Intent(MapsActivityD.this,AdminHorarios.class);
    ...
    private void sendToServer(LatLng latlng) {
        new MapsActivityD.SaveTask().execute(latlng);
    }
    ...
    private class RetrieveTask extends AsyncTask<Void, Void, String>{
        ...
        protected void onPostExecute(String result) {
            ...
            new MapsActivityD.ParserTask().execute(result);
        }
    }

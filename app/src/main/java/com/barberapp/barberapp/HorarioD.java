...
public class HorarioD extends AppCompatActivity implements View.OnClickListener {
    ...
    String HttpURL="https://www.barberapp.cl/BarberApp/InsertAsiento.php";
    String HttpURL3="https://www.barberapp.cl/BarberApp/InsertAsiento2.php";
    ...
    private class BackTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void...params){
            ...
            try{
                ...
                HttpPost httppost= new HttpPost("https://www.barberapp.cl/BarberApp/ListAsiento.php");
